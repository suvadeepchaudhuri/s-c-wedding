      ...
      {!successMessage && (
        <form onSubmit={handleSubmit} className="mb-4">
          <label className="block mb-2">
            Enter RSVP Code:
            <input type="text" value={rsvpCode} onChange={handleRSVPCodeChange} className="block w-full px-2 py-1 border border-gray-300 rounded" />
          </label>
        ...
        <div>
          ...
          <form onSubmit={handleRSVPSubmit}>
            ...
            <div className="mb-4">
              ...
              <select value={numberOfGuests} onChange={handleNumberOfGuestsChange} className="block w-full px-2 py-1 border border-gray-300 rounded">
