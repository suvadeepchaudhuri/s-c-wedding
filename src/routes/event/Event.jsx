...
function Event() {
  return (
    <div className="h-full min-h-screen font-berkshireswash flex flex-col justify-center bg-fixed bg-blend-soft-light bg-repeat-round" style={{ backgroundImage: `url('/bg2.jpg')` }}>
      ...
      <div className="w-10/12 md:w-7/12 lg:6/12 mx-auto relative py-20">
        ...
        <div className="border-l-2 mt-10">
          <div className="flex-auto text-center border-2 m-10 rounded-md bg-white text-2xl p-2">Day-1 (27th December 2023)</div>
          {/* Card 1*/}
          ...
          <div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 border-2 bg-orange-900 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
            ...
            <div className="flex-auto">
              ...
              <h3>Having ethnic patterns drawn on your hands by a professional, using a henna paste. Once the henna is washed off, the patterns remain.</h3>
            </div>
          </div>
          ...
          <div className="flex-auto text-center border-2 m-10 rounded-md bg-white text-2xl p-2">Day-2 (28th December 2023)</div>
          {/* Card4*/}
            ...
            <div className="flex-auto">
              ...
              <h3>
                <ul className='list-disc'>
                  ...
                  <li>
                    Sindoor - Application of red lead oxide powder on the forehead of the bride by the groom.
                  </li>
                </ul>
              </h3>
            </div>
